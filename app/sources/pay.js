  ...
  render() {
    return (
      ...
      {this.state.paid &&
        ...
        <View style={{alignItems:'center'}}>
            <Text style={{color:'white',fontSize:16,paddingTop:100}}>Your payment is successfull</Text>
            <Text style={{color:'white',fontSize:16,paddingTop:10}}># {this.state.token}</Text>
          </View>
